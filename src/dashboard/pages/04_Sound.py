...
from components.filter.filter_sound import vertical_procent_slider, vertical_bpm_slider, vertical_loudness_slider, explicit_chooser, mode_chooser

def sound_layout():
    st.set_page_config(page_title="Sounds", page_icon="🎶", layout="wide")

    # AREA 1 - TITLE
    area1_col1, area1_end= st.columns([99, 1])

    with area1_col1:
        st.markdown(read_textfile(MARKDOWN_PATH / "title_sound.md"))
