...
st.title("🎵 Global Music Trents & Cultural Insights")
...
* 🌍 **Global EDA:** Kulturella skillnader, humör och tempo.
* 📈 **Historical Trends:** Hur de mest virala låtarna presterat över tid.
* 💿 **Physical Media:** Format skiftet från Vinyl till Streaming.

**Instruktioner för UX-teamet:**
Använd sidofältet (sidebar) på respektive sida för att filtrera datan. Dashboarden är uppkopplad live mot vår analytiska databas (DuckDB) som innehåller närmare 30 miljoner rader data.
""")
